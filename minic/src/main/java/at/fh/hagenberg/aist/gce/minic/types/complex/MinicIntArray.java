 ...
 */
public class MinicIntArray extends MinicArray<Integer> {
     ...
     */
    public MinicIntArray(int[] size) {
        super(size);
        array = new int[totalSize];
    }

    @Override
    public Integer getAtPos(int[] pos) {
        return array[getPos(pos)];
    }

    @Override
    public void setAtPos(int[] pos, Integer value) {
