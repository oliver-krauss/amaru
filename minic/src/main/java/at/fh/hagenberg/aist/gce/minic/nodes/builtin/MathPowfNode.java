 ...
 */
@NodeInfo(shortName = "powf", description = "returns x pow y")
public abstract class MathPowfNode extends MinicArgsBuiltinNode {
    ...
    @Specialization
    public float calculateFloat(float val, float exp) {
        return (float) Math.pow(val, exp);
    }

    @Specialization
    public double calculateDouble(double val, double exp) {
