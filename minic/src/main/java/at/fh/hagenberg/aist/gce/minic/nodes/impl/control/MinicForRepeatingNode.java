...
public final class MinicForRepeatingNode extends MinicNode implements RepeatingNode {
    ...
    /**
     * The step node of the loop.
     */
    @Child
    private MinicNode stepNode;
    ...
    public MinicForRepeatingNode(MinicExpressionNode conditionNode, MinicNode stepNode, MinicNode bodyNode) {
