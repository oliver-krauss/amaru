 ...
 */
@NodeInfo(shortName = "builtin", description = "Abstract base class for builtins. Builtins contain java functionality made available for MiniC")
@NodeField(name = "context", type = MinicContext.class)
@GenerateNodeFactory
public abstract class MinicBuiltinNode extends MinicExpressionNode {
