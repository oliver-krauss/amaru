...
public class MinicSourcefileTest {
    ...
    public Object[] dataProvider() throws IOException {
        URL testFolder = this.getClass().getClassLoader().getResource("sort");
    ...
    public void test(TestCase tc) throws IOException {
        ...
        Context ctx = tc.testInput == null ? Context.newBuilder(MinicLanguage.ID).allowExperimentalOptions(true).out(stream).build() :
            Context.newBuilder(MinicLanguage.ID).allowExperimentalOptions(true).arguments(MinicLanguage.ID, tc.testInput).out(stream).build();
        ...
        // then
        Assert.assertEquals(out.toString(), tc.expectedOutput);
    }
