...
/**
 * Same as the Difference Metric but only values absolutes, e.g.
 */
public class AbsDifferenceMetric implements Metric {
    ...
    public AbsDifferenceMetric(TrufflePatternProblem problem, double minDifferential, double maxDifferential, List<TrufflePatternProblem> oppositeProblems) {
