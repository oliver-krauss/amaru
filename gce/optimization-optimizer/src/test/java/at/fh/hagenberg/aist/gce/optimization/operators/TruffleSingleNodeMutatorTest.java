...
public class TruffleSingleNodeMutatorTest {

    private TruffleSingleNodeMutator mutator;
    ...
    public void setUp() {
        // build mutation
        mutator = new TruffleSingleNodeMutator();
        ...
        mutator.setMutationChoice(new RandomChooser<>());
        mutator.setStrategies(strategies);
    }
