 ...
 */
public class TruffleMasterStrategyFindPatternsTest extends AbstractPatternsTest {
    ...
    public void testFindWhilePattern() {
        ...
        create().injectPattern(hardAntiPattern, meta, 1);
        ...
        Requirement requirement = reqsWrite.getRequirementInformation().getRequirements().keySet().stream().filter(x -> x.getName().equals(Requirement.REQ_PATTERN)).findFirst().orElse(null);
    ...
    public void testFindNChildPatternWithChildren() {
        ...
        // when
        create().injectPattern(antiPattern, meta, 1);
    ...
    public void testFindViolatedValueReq() {
        ...
        TruffleLanguageInformation tli = TruffleLanguageInformation.getLanguageInformation(MinicLanguage.ID);
        create().injectPattern(antiPattern, datatypeIndependentMeta, 1);
