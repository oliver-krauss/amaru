...
array nn_relu(int numTrainingSets, float output[], float training_inputs[][], float training_outputs[][]) {
...
array nn_entry(int numTrainingSets, float training_inputs_raw[], float training_outputs_raw[]) {
    ...
    nn_relu(numTrainingSets, output, training_inputs, training_outputs);
